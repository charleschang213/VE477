...
int main(){
    ...
    ans1 = kruskal(&g1);
    printf("Kruskal: ");
    for (int i=0;i<g1.size-1;i++) printf("<V%d,V%d> ",ans1[i].x+1,ans1[i].y+1);
    printf("\n");
    free(ans1);
    graph_init(&g2,6,10);
    ...
    ans2 = prim(&g2);
    printf("Prim: ");
    for (int i=0;i<g2.size-1;i++) printf("<V%d,V%d> ",ans2[i].x+1,ans2[i].y+1);
    printf("\n");
    free(ans2);
    graph_clean(&g2);
    graph_clean(&g1);
    printf("######################################\n\n");
    printf("##Part I: Checking for correctness(2)#\n");
    graph_init(&g1,6,8);
    g1.edg[0].x = 0; g1.edg[0].y = 1;g1.edg[0].val=3;
    g1.edg[1].x = 0; g1.edg[1].y = 2;g1.edg[1].val=1;
    g1.edg[2].x = 0; g1.edg[2].y = 3;g1.edg[2].val=5;
    g1.edg[3].x = 1; g1.edg[3].y = 2;g1.edg[3].val=5;
    g1.edg[4].x = 2; g1.edg[4].y = 3;g1.edg[4].val=2;
    g1.edg[5].x = 2; g1.edg[5].y = 4;g1.edg[5].val=4;
    g1.edg[6].x = 3; g1.edg[6].y = 5;g1.edg[6].val=5;
    g1.edg[7].x = 4; g1.edg[7].y = 5;g1.edg[7].val=4;
    ans1 = kruskal(&g1);
    printf("Kruskal: ");
    for (int i=0;i<g1.size-1;i++) printf("<V%d,V%d> ",ans1[i].x+1,ans1[i].y+1);
    printf("\n");
    free(ans1);
    graph_init(&g2,6,8);
    g2.edg[0].x = 0; g2.edg[0].y = 1;g2.edg[0].val=3;
    g2.edg[1].x = 0; g2.edg[1].y = 2;g2.edg[1].val=1;
    g2.edg[2].x = 0; g2.edg[2].y = 3;g2.edg[2].val=5;
    g2.edg[3].x = 1; g2.edg[3].y = 2;g2.edg[3].val=5;
    g2.edg[4].x = 2; g2.edg[4].y = 3;g2.edg[4].val=2;
    g2.edg[5].x = 2; g2.edg[5].y = 4;g2.edg[5].val=4;
    g2.edg[6].x = 3; g2.edg[6].y = 5;g2.edg[6].val=5;
    g2.edg[7].x = 4; g2.edg[7].y = 5;g2.edg[7].val=4;
    ans2 = prim(&g2);
    printf("Prim: ");
    for (int i=0;i<g2.size-1;i++) printf("<V%d,V%d> ",ans2[i].x+1,ans2[i].y+1);
    printf("\n");
